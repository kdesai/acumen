...
$query = "SELECT * FROM `news_201408` WHERE `RELTEAD_TICKERS_JSON` LIKE '%AAPL:US%';";
                ...
                <section class="content">
					...
					<?php
						...
						for ($i=0; $i<$num_articles; $i++) {
							...
							echo '<div class="row">
									<div class="col-md-12">
										<div class="box box-solid box-success collapsed-box">
											...
											echo "<h3 class=\"box-title pull-left\">{$row['TITLE']}</h3>";
											echo '</div>
											<div style="display: none;" class="box-body">
												...
												<script src=js/responsiveVoice.js></script>
													<script> pl<?php echo $i;?> = function(){
														var abc = "<?php echo strip_tags($row['CONTENT']); ?>";
							...
							<script src=js/ResponseVoice.js></script>
							<script>
							function play(){
								ResponseVoice.speak($row[CONTENT],ResponseVoice.setDefaultVoice());
							}';*/
						}
					?>
