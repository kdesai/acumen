...
$TICKER = array_key_exists('TICKER_NAME',$_GET)?$_GET['TICKER_NAME']:"AAPL:US";
                ...
                <section class="sidebar">
                    ...
                    <form action="#" method="get" class="sidebar-form">
                        <div class="input-group">
                            <input type="text" name="q" class="form-control" placeholder="Search Ticker..."/>
                    ...
                    <ul class="sidebar-menu">
						...
						<li>
							<a href="news.php?TICKER=AAPL:US">
						 ...
						 <!-- Calendar -->
                            ...
                            <div class="nav-tabs-custom">
                                ...
                                <ul class="nav nav-tabs pull-right">
                                    ...
                                    <li class="pull-left header"><i class="fa fa-inbox"></i>Relation Map</li>
